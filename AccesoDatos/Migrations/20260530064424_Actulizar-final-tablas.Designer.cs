...
namespace AccesoDatos.Migrations
{
    ...
    [Migration("20260530064424_Actulizar-final-tablas")]
    partial class Actulizarfinaltablas
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entidades.Especialidad", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            descripcion = "Consultas generales y chequeos médicos completos."
                        },
                        new
                        {
                            Id_Especialidad = 2,
                            Nombre_especialidad = "Odontología",
                            descripcion = "Cuidado dental, limpieza y salud bucal integral."
                        },
                        new
                        {
                            Id_Especialidad = 3,
                            Nombre_especialidad = "Pediatría",
                            descripcion = "Atención médica y control del desarrollo infantil"
                        },
                        new
                        {
                            Id_Especialidad = 4,
                            Nombre_especialidad = "Ginecología",
                            descripcion = "Salud reproductiva femenina, control y embarazo."
                        },
                        new
                        {
                            Id_Especialidad = 5,
                            Nombre_especialidad = "Psicología",
                            descripcion = "Terapia emocional, apoyo mental y bienestar integral."
                        },
                        new
                        {
                            Id_Especialidad = 6,
                            Nombre_especialidad = "Oftalmología",
                            descripcion = "Exámenes de la vista y tratamiento de problemas oculares."
                        });
                });
